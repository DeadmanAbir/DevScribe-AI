...
<div className="font-semibold text-xl md:mt-0 mt-5">Know the architecture</div>
        <div className="flex   gap-1 font-medium mt-2">
          <Link href="https://deadmanabir.hashnode.dev/building-a-chatbot-with-chat-history-using-langchain-jsts-a-step-by-step-guide" target='_blank' className='flex gap-2 items-center text-gray-700 hover:text-slate-900'> <span>Read the Blog </span> <ArrowUpRightFromSquare className='h-4 w-4'/> </Link>
        
        </div>
</div>
<div className='flex flex-col'>
<div className="font-semibold text-xl md:mt-0 mt-5">Important Links</div>
